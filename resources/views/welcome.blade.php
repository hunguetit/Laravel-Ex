...
<html>
<head>
<title>Bicycle Sport Shop</title>
      ...
      <div class="container">
             <div class="header">
                  ...
                  <div class="top-nav">                                      
                       ...
                       <ul class="nav">
                          <li class="dropdown1"><a href="{{ asset('bike') }}">BICYCLES</a>
                              <ul class="dropdown2">
                                    <li><a href="{{ asset('bike') }}">FIXED / SINGLE SPEED</a></li>
                                    <li><a href="{{ asset('bike') }}">CITY BIKES</a></li>
                                    <li><a href="{{ asset('bike') }}">PREMIMUN SERIES</a></li>                                                
                              </ul>
                          </li>
                         ...
                         @else
                             <li class="dropdown dropdown-user">
                                ...
                                <ul>
                                    ...
                                    @endif
                                    <li>
                                        <a href="{{asset('profile/'. Auth::user()->id )}}">
                            ...
                            @if (Auth::user()->role == "user")
                                <a class="shop" href="cart.html"><img src="{{ asset('/frontend/images/cart.png') }}" alt=""/></a>
                            @endif
                        @endif
                      </ul>
                 </div>
     ...
     <div class="caption">
         <div class="slider">
           <div class="callbacks_container">
              ...
              <a class="morebtn" href="{{ asset('bike') }}">SHOP BIKES</a>
          </div>
      </div>
     </div>
     <div class="dwn">
...
<div id="cate" class="categories">
     <div class="container">
         ...
         <div class="categorie-grids">
             ...
             <a href="{{ asset('bike') }}"><div class="col-md-4 cate-grid grid2">
                 <h4>PREMIMUM SERIES</h4>
                 <p>Exclusive Bike Components</p>
                 <a class="store" href="{{ asset('bike') }}">GO TO STORE</a>
             </div></a>
             <a href="{{ asset('bike') }}"><div class="col-md-4 cate-grid grid3">
                 <h4>CITY BIKES</h4>
...
<div class="bikes"> 
         ...
         <div class="bikes-grids">           
             <ul id="flexiselDemo1">
                 <li>
                     <img src="{{ asset('/frontend/images/bik1.jpg' )}}" alt=""/>
                     <div class="bike-info">
                         <div class="model">
                         ...
                         <div class="model-info">
                             ...
                             <a href="{{ asset('bike') }}">BUY</a>
                         </div>                      
                         <div class="clearfix"></div>
                     </div>
                     <div class="viw">
                        <a href="{{ asset('bike') }}">Quick View</a>
                     </div>
                 </li>
                 <li>
...
<div class="footer">
     <div class="container wrap">
        ...
        <div class="ftr-menu">
             <ul>
                 <li><a href="{{ asset('bike') }}">BICYCLES</a></li>
