                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                            		...
                            		<p>Enter your email and new password to reset password:</p>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" method="POST" action="{{ url('/password/reset') }}" class="login-form">
			                        ...
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-password">Confirm Password
                                            <span class="required">* </span>
                                        </label>
			                        	<input type="password" name="password_confirmation" placeholder="Re-Password..." class="form-password form-control" id="form-password">
			                        </div>
